...
class queko:
    ...
    def sprinkle_1qbg(self):
        ...
        if num_avail_nodes < self.count_1qbg - self.count_1qbg_now:
            raise ValueError(
                "Failed to sprinkle 1-qubit gates, might have asked for too many."
            )
    ...
    def sprinkle_2qbg(self):
        ...
        if num_avail_edges < self.count_2qbg - self.count_2qbg_now:
            raise ValueError(
                "Failed to sprinkle 2-qubit gates, might have asked for too many."
            )
    ...
    def shuffle_nodes(self):
        ...
        for cycle in self.cycles:
            ...
            for tmp_2qbg in cycle.list_2qbg:
                cycle_test.add_2qbg(
                    (self.nodes_to_test[tmp_2qbg[0]], self.nodes_to_test[tmp_2qbg[1]])
                )
